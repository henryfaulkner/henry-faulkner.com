import { axis, debounce, generateClientRects, type Rect } from "./utils";

function RunScript() {
  let rootEl = document.querySelector(
    "[data-perspective-group]"
  ) as HTMLElement;
  let els = Array.from(
    rootEl.querySelectorAll("[data-perspective]")
  ) as HTMLElement[];
